...
Update_Confluence_Page("https://janisoncls.atlassian.net", "JAST", "469664600", "469664606", "Insights Test Automation Reports", $storage_format)
_SQLite_Close()
_SQLite_Shutdown()
...
_Toast_Show(0, $app_name, "Uploading reports to confluence", -300, False, True)
Update_Confluence_Page("https://janisoncls.atlassian.net", "JAST", "474087425", "473989127", "Learning Test Automation Reports", $storage_format)
_SQLite_Close()
_SQLite_Shutdown()
